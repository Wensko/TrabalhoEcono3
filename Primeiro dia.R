...
hepatite.panel <- reshape(hepatite, idvar = 'códigos', timevar = "ano", varying = list(3:13), ids = rownames(hepatite) , direction = "long", sep = " ")
...
polio.panel <- reshape(polio, idvar = 'códigos', timevar = "ano", varying = list(3:13), ids = rownames(polio) , direction = "long", sep = " ")
...
tri_bact.panel <- reshape(tri_bact, idvar = 'códigos', timevar = "ano", varying = list(3:13), ids = rownames(tri_bact) , direction = "long", sep = " ")
...
tri_viral.panel <- reshape(tri_viral, idvar = 'códigos', timevar = "ano", varying = list(3:13), ids = rownames(tri_viral) , direction = "long", sep = " ")
...
pneumo.panel <- reshape(pneumo, idvar = 'códigos', timevar = "ano", varying = list(3:8), ids = rownames(pneumo) , direction = "long", sep = " ")
